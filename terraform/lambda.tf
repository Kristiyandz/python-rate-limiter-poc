...
resource "aws_lambda_permission" "apigw_lambda" {
  ...
  source_arn = "arn:aws:execute-api:eu-west-2:580549185469:${aws_api_gateway_rest_api.MyDemoAPI.id}/*/${aws_api_gateway_method.method.http_method}${aws_api_gateway_resource.resource.path}"
}
